; ModuleID = 'regParams.bc'
source_filename = "regParams.c"
...
define dso_local i16 @offSum(i16 %A, i16 %B, i16 %C, i16 %D, i16 %E) #0 {
entry:
...
entry:
  ...
  %call = call i16 @offSum(i16 %0, i16 %1, i16 %2, i16 %3, i16 %4)
